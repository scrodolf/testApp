...
class $ProductUnitOverridesTable extends ProductUnitOverrides
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ProductUnitOverridesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumn<double> factorToBase = GeneratedColumn<double>(
      ...
      type: DriftSqlType.double, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, productId, unitId, factorToBase];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'product_unit_overrides';
  @override
  VerificationContext validateIntegrity(
      Insertable<ProductUnitOverride> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ProductUnitOverride map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ProductUnitOverride(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      productId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}product_id'])!,
  ...
  @override
  $ProductUnitOverridesTable createAlias(String alias) {
    return $ProductUnitOverridesTable(attachedDatabase, alias);
  }
}

class ProductUnitOverride extends DataClass
    implements Insertable<ProductUnitOverride> {
  final int id;
  ...
  ProductUnitOverridesCompanion toCompanion(bool nullToAbsent) {
    return ProductUnitOverridesCompanion(
      id: Value(id),
      productId: Value(productId),
      unitId: Value(unitId),
      factorToBase: Value(factorToBase),
  ...
  factory ProductUnitOverride.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ProductUnitOverride(
      id: serializer.fromJson<int>(json['id']),
  ...
  ProductUnitOverride copyWith(
          {int? id, int? productId, int? unitId, double? factorToBase}) =>
      ProductUnitOverride(
        id: id ?? this.id,
        productId: productId ?? this.productId,
        unitId: unitId ?? this.unitId,
  ...
  ProductUnitOverride copyWithCompanion(ProductUnitOverridesCompanion data) {
    return ProductUnitOverride(
      id: data.id.present ? data.id.value : this.id,
      productId: data.productId.present ? data.productId.value : this.productId,
      unitId: data.unitId.present ? data.unitId.value : this.unitId,
  ...
  @override
  String toString() {
    return (StringBuffer('ProductUnitOverride(')
          ..write('id: $id, ')
          ..write('productId: $productId, ')
          ..write('unitId: $unitId, ')
          ..write('factorToBase: $factorToBase')
  ...
  @override
  int get hashCode => Object.hash(id, productId, unitId, factorToBase);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProductUnitOverride &&
          other.id == this.id &&
          other.productId == this.productId &&
          other.unitId == this.unitId &&
          other.factorToBase == this.factorToBase);
...
class ProductUnitOverridesCompanion
    extends UpdateCompanion<ProductUnitOverride> {
  final Value<int> id;
  final Value<int> productId;
  final Value<int> unitId;
  final Value<double> factorToBase;
  const ProductUnitOverridesCompanion({
    this.id = const Value.absent(),
    this.productId = const Value.absent(),
    this.unitId = const Value.absent(),
    this.factorToBase = const Value.absent(),
  ...
  ProductUnitOverridesCompanion.insert({
    ...
    required double factorToBase,
        ...
        unitId = Value(unitId),
        factorToBase = Value(factorToBase);
  static Insertable<ProductUnitOverride> custom({
    Expression<int>? id,
    Expression<int>? productId,
    Expression<int>? unitId,
    Expression<double>? factorToBase,
  ...
  ProductUnitOverridesCompanion copyWith(
      {Value<int>? id,
      Value<int>? productId,
      Value<int>? unitId,
      Value<double>? factorToBase}) {
  ...
  @override
  String toString() {
    return (StringBuffer('ProductUnitOverridesCompanion(')
          ..write('id: $id, ')
          ..write('productId: $productId, ')
          ..write('unitId: $unitId, ')
          ..write('factorToBase: $factorToBase')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ProductUnitOverridesTable productUnitOverrides =
      $ProductUnitOverridesTable(this);
...
final class $$UnitsTableReferences
  ...
  static MultiTypedResultKey<$ProductUnitOverridesTable,
      List<ProductUnitOverride>> _productUnitOverridesRefsTable(
          _$AppDatabase db) =>
      MultiTypedResultKey.fromTable(db.productUnitOverrides,
          aliasName: $_aliasNameGenerator(
              db.units.id, db.productUnitOverrides.unitId));

  $$ProductUnitOverridesTableProcessedTableManager
      get productUnitOverridesRefs {
    final manager =
        $$ProductUnitOverridesTableTableManager($_db, $_db.productUnitOverrides)
            .filter((f) => f.unitId.id($_item.id));

    final cache =
        $_typedResult.readTableOrNull(_productUnitOverridesRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
...
class $$UnitsTableFilterComposer extends Composer<_$AppDatabase, $UnitsTable> {
  ...
  Expression<bool> productUnitOverridesRefs(
      Expression<bool> Function($$ProductUnitOverridesTableFilterComposer f)
          f) {
    final $$ProductUnitOverridesTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.id,
        referencedTable: $db.productUnitOverrides,
        getReferencedColumn: (t) => t.unitId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
...
class $$UnitsTableAnnotationComposer
  ...
  Expression<T> productUnitOverridesRefs<T extends Object>(
      Expression<T> Function($$ProductUnitOverridesTableAnnotationComposer a)
          f) {
    final $$ProductUnitOverridesTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.id,
            referencedTable: $db.productUnitOverrides,
  ...
  $$UnitsTableTableManager(_$AppDatabase db, $UnitsTable table)
      : super(TableManagerState(
          ...
          prefetchHooksCallback: (
              ...
              productUnitOverridesRefs = false,
            ...
            return PrefetchHooks(
              ...
              explicitlyWatchedTables: [
                ...
                if (productUnitOverridesRefs) db.productUnitOverrides,
                ...
                return [
                  ...
                  if (productCategoryValuesRefs)
                    await $_getPrefetchedData(
                        ...
                        typedResults: items),
                  if (productUnitOverridesRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable: $$UnitsTableReferences
                            ._productUnitOverridesRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$UnitsTableReferences(db, table, p0)
                                .productUnitOverridesRefs,
                        referencedItemsForCurrentItem: (item,
                                referencedItems) =>
                            referencedItems.where((e) => e.unitId == item.id),
                        typedResults: items),
...
final class $$ProductsTableReferences
  ...
  static MultiTypedResultKey<$ProductUnitOverridesTable,
      ...
      MultiTypedResultKey.fromTable(db.productUnitOverrides,
          aliasName: $_aliasNameGenerator(
              db.products.id, db.productUnitOverrides.productId));
...
typedef $$ProductCategoryValuesTableProcessedTableManager
    = ProcessedTableManager<
        ...
        ProductCategoryValue,
        PrefetchHooks Function({bool productId, bool categoryId, bool unitId})>;
typedef $$ProductUnitOverridesTableCreateCompanionBuilder
    = ProductUnitOverridesCompanion Function({
  Value<int> id,
  required int productId,
  required int unitId,
  required double factorToBase,
});
typedef $$ProductUnitOverridesTableUpdateCompanionBuilder
    = ProductUnitOverridesCompanion Function({
  Value<int> id,
  Value<int> productId,
  Value<int> unitId,
...
final class $$ProductUnitOverridesTableReferences extends BaseReferences<
    _$AppDatabase, $ProductUnitOverridesTable, ProductUnitOverride> {
  $$ProductUnitOverridesTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $ProductsTable _productIdTable(_$AppDatabase db) =>
      db.products.createAlias($_aliasNameGenerator(
          db.productUnitOverrides.productId, db.products.id));
  ...
  static $UnitsTable _unitIdTable(_$AppDatabase db) => db.units.createAlias(
      $_aliasNameGenerator(db.productUnitOverrides.unitId, db.units.id));
...
class $$ProductUnitOverridesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ProductUnitOverridesTable,
    ProductUnitOverride,
    $$ProductUnitOverridesTableFilterComposer,
    $$ProductUnitOverridesTableOrderingComposer,
    $$ProductUnitOverridesTableAnnotationComposer,
    $$ProductUnitOverridesTableCreateCompanionBuilder,
    $$ProductUnitOverridesTableUpdateCompanionBuilder,
    (ProductUnitOverride, $$ProductUnitOverridesTableReferences),
    ProductUnitOverride,
  ...
  $$UnitsTableTableManager(_$AppDatabase db, $UnitsTable table)
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$ProductUnitOverridesTableReferences(db, table, e)
                  ))
              .toList(),
              ...
              addJoins: <
                ...
                if (productId) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.productId,
                    referencedTable: $$ProductUnitOverridesTableReferences
                        ._productIdTable(db),
                    referencedColumn: $$ProductUnitOverridesTableReferences
                        ._productIdTable(db)
                        .id,
                  ) as T;
                }
                if (unitId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.unitId,
                    referencedTable:
                        $$ProductUnitOverridesTableReferences._unitIdTable(db),
                    referencedColumn: $$ProductUnitOverridesTableReferences
                        ._unitIdTable(db)
                        .id,
                  ) as T;
...
typedef $$ProductUnitOverridesTableProcessedTableManager
    = ProcessedTableManager<
        _$AppDatabase,
        $ProductUnitOverridesTable,
        ProductUnitOverride,
